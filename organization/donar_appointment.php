    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active"  href="donar_appointment.php">Donar Requests</a>
                </li>
                <li class="nav-item">
          ...
          <?php
                ...
                $city=$row1['city'];
                $sql="SELECT * FROM donar_requests WHERE allotment_status=0 and donar_city='$city';";
                ...
                if($result==true)
                {
                    if(mysqli_num_rows($result)>0)
                    {
                        ...
                        {   
                            ...
                            <form id='form_register' method='POST' action='handler_org.php?req=allot_donar&token=$row[token]'>
                            <tr>
