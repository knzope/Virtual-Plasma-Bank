    ...
    ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="profile_org.php">Your Profile</a>
                </li>
                <!-- <li class="nav-item">
        ...
        echo "<div class='container' id='i2'>
          <table id='table' class='table table-hover'>
            ...
            <tr>
                <th>
                    <a class='btn btn-link'  href='update_org.php' style='font-size: 20px;'>Update Details</a>
                </th>
                <td>
                </td>
            </tr>
            <tr>
                <th>
                    <a class='btn btn-link'  href='handler_org.php?req=forgot_pass' style='font-size: 20px;'>Forgot Password?</a>
                </th>
                <td>
                </td>
            </tr>
            <tr>
                <th>
                        <form id='form_register' method='POST' action='handler_org.php?req=logout'>
                            <input type='submit' class='btn btn-primary' value='LOGOUT'> 
                        </form>
                </th>
                <td>
                <form id='form_register' method='POST' action='handler_org.php?req=delete_account&token=$row[initialtoken]'>
