<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
          ...
          <?php
                ...
                $db=new database();
                $conn=$db->connect();
                $sql="SELECT * FROM organizational_user WHERE approval_status=0;";
                ...
                if($result==true)
                {
                    if(mysqli_num_rows($result)>0)
                    {
                          ...
                          <tr>
                            ...
                            <tr>
                                ...
                                <div class='container text-center'>
                                    <img class='img-thumbnail' alt='Responsive image' src='../organization/Approval_plasma_bank_upload/$row[approvalfile]'>
                                </div>
                                
                                
                            </tr>
                            <tr>
                              <td><a href='handler_admin.php?req=bank_approve&token=$row[initialtoken]'><input type='button' class='btn btn-primary' value='Approve'></a></td>
                              <td><a href='handler_admin.php?req=bank_reject&token=$row[initialtoken]'><input type='button' class='btn btn-danger' value='Reject'></td>
                            </tr>
                      ...
                      echo "<div class='container' id='i2'><p><h1 class='text-center'>No Bank Requests.</h1></p></div>";
                    }
                  }
                else
                {
