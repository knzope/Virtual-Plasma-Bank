    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active"  href="search_plasmabank.php">Manage Plasma Banks</a>
                </li>
                <li class="nav-item">
          ...
          <div class="container" id="s1">
              <form class="form-inline my-2 my-lg-0" method="POST" action="search_plasmabank.php">
            ...
            <?php
                    ...
                    {
                      $search=$_POST['search'];
                      $sql="SELECT * FROM organizational_user WHERE pbname like '%$search%' or email like '%$search%';";
                      $result=mysqli_query($conn,$sql);
                            if($result==true)
                            {
                                if(mysqli_num_rows($result)>0)
                                {
                                    ...
                                    while($row=mysqli_fetch_assoc($result))
                                    {
                                        echo "<table id='table' class='table table-hover table-bordered'>
                                            ...
                                            <th>Bank Detail</th>
                                            <td>
                                                Name: <a href='plasmabank_page.php?token=$row[initialtoken]'>$row[pbname]</a><br>
                                                Email: $row[email]<br>
                                                Mobile No.: $row[phone]
                                            </td>
                                            </tr>
                                ...
                                {
                                    echo "<div class='container' id='i2'><p><h1 class='text-center'>No Bank Users.</h1></p></div>";
